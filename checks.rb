...
repositories = [
  ...
  Repository.new("kddnewton", "ccaniuse", []),
  ...
  Repository.new("kddnewton", "typescript-parse-math", ["javascript"]),
...
checks = [
  ...
  Check.new("Gemspec - files", ["gem"]) { |client| client.contents_decoded("#{client.repository.name}.gemspec")&.match?(/spec\.files = (?:%w)?\[/) },
